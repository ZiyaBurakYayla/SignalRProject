...
namespace SignalR.DataAccessLayer.Migrations
{
    ...
    [Migration("20260615122547_MigUpdateNotification")]
    partial class MigUpdateNotification
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.OrderTable", b =>
                {
                    b.Property<int>("OrderTableId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OrderTableName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Basket", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.OrderTable", "OrderTable")
                        .WithMany("Baskets")
